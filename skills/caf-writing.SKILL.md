...
53|**路径**: `/mnt/f/创作/奇迹/caf-writing/skills/novel_kb_ref/craft_patterns/scene_mechanics_patterns.md`
54|五个门禁：
...
62|**路径**: `/mnt/f/创作/奇迹/caf-writing/skills/novel_kb_ref/craft_patterns/plot_traction_patterns.md`
63|- 外部欲望是否存在
64|- 失败代价是否具体
65|- 对手是否攻击欲望和弱点
66|- 中点是否改变情境或主动权
...
70|**路径**: `/mnt/f/创作/奇迹/caf-writing/skills/novel_kb_ref/craft_patterns/character_arc_patterns.md`
71|信念 → 裂痕 → 成长 → 新信念
72|
73|### 章节质量评估 → Quality Rubrics（必须打分）
74|**路径**: `/mnt/f/创作/奇迹/caf-writing/skills/novel_kb_ref/quality_gates/QUALITY_RUBRICS.md`
75|六维度 0-3 评分：
76|1. Hook 入口压力
...
84|**路径**: `/mnt/f/创作/奇迹/caf-writing/skills/novel_lab_ref/craft-notes.md`
85|
86|### 故障诊断
87|**路径**: `/mnt/f/创作/奇迹/caf-writing/skills/novel_kb_ref/diagnostics/`
88|
89|## Agent 接口速查
90|
91|| 函数 | 用途 |
